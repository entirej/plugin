...
public class EJReportVisualAttributePage extends AbstractEditorPage implements PageActionHandlerProvider
{
    private EJReportPropertiesEditor   editor;
    private ReportVisualAttTreeSection treeSection;
    public static final String   PAGE_ID = "ej.visualattributes"; //$NON-NLS-1$

    public EJReportVisualAttributePage(EJReportPropertiesEditor editor)
    {
        super(editor, PAGE_ID, EJUIMessages.EJVisualAttributePage);
        this.editor = editor;
    }
    ...
    protected void buildBody(IManagedForm managedForm, FormToolkit toolkit)
    {
        ...
        treeSection = new ReportVisualAttTreeSection(editor, this, body);
    ...
    {
        return EJUIMessages.EJVisualAttributePage;
    }
