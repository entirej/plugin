...
public class ReportParametersPart extends SectionPart
{
    ...
    public ReportParametersPart(final EJReportPropertiesEditor editor, FormPage page, Composite parent)
    {
    ...
    protected void buildBody(Section section, FormToolkit toolkit)
    {
        ...
        section.setDescription("These parameters are available throughout the application and can be directly referenced by report block items.");
