...
public class NewEntireJReportProjectWizard extends NewWizard implements IExecutableExtension
{
    ...
    private NewEJReportProjectConfigPage      projectSettingsPage;

    private IConfigurationElement       configElement;

    public NewEntireJReportProjectWizard()
    {
        setDefaultPageImageDescriptor(EJUIImages.DESC_NEWEJPRJ_WIZ);
        setDialogSettings(EJUIPlugin.getDefault().getDialogSettings());
        setWindowTitle(EJUIMessages.NewReportProjectWizard_title);
    ...
    public void addPages()
    {
        ...
        projectCreationPage.setTitle(EJUIMessages.NewReportProjectWizard_MainPage_title);
        projectCreationPage.setDescription(EJUIMessages.NewReportProjectWizard_MainPage_desc);
        String pname = getDefaultValue(DEF_PROJECT_NAME);
        if (pname != null)
            projectCreationPage.setProjectName(pname);
        addPage(projectCreationPage);

        projectSettingsPage = new NewEJReportProjectConfigPage();
