...
public class EJReportPerspective implements IPerspectiveFactory
{
    ...
    public void createInitialLayout(IPageLayout layout)
    {
        ...
        // Add "new wizards".
        layout.addNewWizardShortcut(EJReportUIConstants.EJ_REPORT_PROJECT_WIZARD_ID);
        layout.addNewWizardShortcut(EJReportUIConstants.EJ_REPORT_WIZARD_ID);
        layout.addNewWizardShortcut(EJReportUIConstants.EJ_REPORT_SERVICE_WIZARD_ID);
        ...
        layout.addActionSet(EJReportUIConstants.EJ_REPORT_ACTION_SET_ID);
