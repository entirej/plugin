...
public class NewEntireJProjectWizard extends NewWizard implements IExecutableExtension
{
    ...
    public NewEntireJProjectWizard()
    {
        ...
        setWindowTitle(EJFormUIMessages.NewProjectWizard_title);
    ...
    public void addPages()
    {
        ...
        projectCreationPage.setTitle(EJFormUIMessages.NewProjectWizard_MainPage_title);
        projectCreationPage.setDescription(EJFormUIMessages.NewProjectWizard_MainPage_desc);
