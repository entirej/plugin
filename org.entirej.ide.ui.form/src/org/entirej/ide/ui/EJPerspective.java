...
public class EJPerspective implements IPerspectiveFactory
{
    ...
    public void createInitialLayout(IPageLayout layout)
    {
        ...
        // Add "new wizards".
        layout.addNewWizardShortcut(EJFormUIConstants.EJ_PROJECT_WIZARD_ID);
        layout.addNewWizardShortcut(EJFormUIConstants.EJ_FORM_WIZARD_ID);
        layout.addNewWizardShortcut(EJFormUIConstants.EJ_SERVICE_WIZARD_ID);
        layout.addNewWizardShortcut(EJFormUIConstants.EJ_REUSABLEBLOCK_WIZARD_ID);
        layout.addNewWizardShortcut(EJFormUIConstants.EJ_REUSABLELOVDEF_WIZARD_ID);
        layout.addNewWizardShortcut(EJFormUIConstants.EJ_REUSABLEOBJECT_GROUP);
        ...
        layout.addActionSet(EJFormUIConstants.EJ_ACTION_SET_ID);
