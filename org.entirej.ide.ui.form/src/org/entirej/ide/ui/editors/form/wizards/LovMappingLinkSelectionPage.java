...
public class LovMappingLinkSelectionPage extends WizardPage
{

    private final LovMappingLinkWizardContext wizardContext;

    private String                            defItem;
    private String                            blockItem;

    protected LovMappingLinkSelectionPage(LovMappingLinkWizardContext wizardContext)
    {
        super("ej.lov.mapping.link.selection");
        this.wizardContext = wizardContext;
        setTitle("LOV Item Mapping");
        setDescription("Properties for the new LOV item mapping.");
    }
    ...
    private void createMasterBlockLabel(Composite composite, int nColumns)
    {
        ...
        formTitleLabel.setText("LOV Definition Item:");
    ...
    private void createMasterBlockControls(Composite composite, int nColumns)
    {
        ...
        masterBlockViewer.setContentProvider(new IStructuredContentProvider()
        {
            ...
            {
                List<String> renderers = wizardContext.getDefItems();
        ...
        masterBlockViewer.addSelectionChangedListener(new ISelectionChangedListener()
        {
            ...
            public void selectionChanged(SelectionChangedEvent event)
            {
                ...
                if (masterBlockViewer.getSelection() instanceof IStructuredSelection)
                    defItem = (String) ((IStructuredSelection) masterBlockViewer.getSelection()).getFirstElement();
                doUpdateStatus();
            }
        });
    ...
    {
        Label formTitleLabel = new Label(composite, SWT.NULL);
        formTitleLabel.setText("Block Item:");
        GridData gd = new GridData(GridData.FILL_HORIZONTAL | GridData.GRAB_HORIZONTAL);
        formTitleLabel.setLayoutData(gd);
    }
    ...
    private void createDetailsBlockControls(Composite composite, int nColumns)
    {
        ...
        masterBlockViewer.setContentProvider(new IStructuredContentProvider()
        {
            ...
            public Object[] getElements(Object inputElement)
            {
                List<String> renderers = wizardContext.getBlockItems();
        ...
        masterBlockViewer.addSelectionChangedListener(new ISelectionChangedListener()
        {
            ...
            public void selectionChanged(SelectionChangedEvent event)
            {
                ...
                if (masterBlockViewer.getSelection() instanceof IStructuredSelection)
                    blockItem = (String) ((IStructuredSelection) masterBlockViewer.getSelection()).getFirstElement();
                doUpdateStatus();
            }
        });
    ...
    protected boolean validatePage()
    {
        ...
        if (defItem == null)
        {
            setErrorMessage("A LOV definition item must be specified.");
            return false;
        }
        if (blockItem == null)
        {
            setErrorMessage("A block item must be specified.");
            return false;
        }
