...
public class DataBlockServiceWizard extends NewWizard
{
    ...
    protected void finishPage(IProgressMonitor monitor) throws InterruptedException, CoreException
    {
        ...
        wizardContext.addBlock(selectionPage.getBlockName(), selectionPage.getBlockRenderer(), createCanvas ? selectionPage.getNewCanvasName() : canvasName,
                createCanvas, selectionPage.getBlockServiceClass());
