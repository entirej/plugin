...
public class EJRenderersPage extends AbstractEditorPage implements PageActionHandlerProvider
{
    private EJPropertiesEditor  editor;
    private RendererTreeSection treeSection;
    public static final String  PAGE_ID = "ej.renderers"; //$NON-NLS-1$

    public EJRenderersPage(EJPropertiesEditor editor)
    {
        super(editor, PAGE_ID, EJFormUIMessages.EJRenderersPage_title);
        this.editor = editor;
    }
    ...
    protected void buildBody(IManagedForm managedForm, FormToolkit toolkit)
    {
        ...
        treeSection = new RendererTreeSection(editor, this, body);
    ...
    {
        return EJFormUIMessages.EJRenderersPage_title;
    }
