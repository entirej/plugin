...
public class FormPackagesPart extends SectionPart
{
    ...
    public FormPackagesPart(final EJPropertiesEditor editor, FormPage page, Composite parent)
    {
    ...
    {
        section.setText("Form Packages");
        section.setDescription("Choose the packages where the forms configuration files will be stored.");
    ...
    public void createViewer(Composite body)
    {
        ...
        viewer.setContentProvider(new IStructuredContentProvider()
        {
            ...
            public Object[] getElements(Object inputElement)
            {
                ...
                return editor.getEntireJProperties().getFormPackageNames().toArray();
            }
        });
    ...
    private void createButtons(final Composite body, FormToolkit toolkit)
    {
        ...
        addButton.addSelectionListener(new SelectionAdapter()
        {
            ...
            {
                final EJPluginEntireJProperties entireJProperties = editor.getEntireJProperties();
                IPackageFragmentFilter fragmentFilter = new IPackageFragmentFilter()
                {

                    public boolean acccept(IPackageFragment fragment)
                    {
                        return !entireJProperties.getFormPackageNames().contains(packageToPath(fragment.getElementName()));
                    }
                };
                ...
                if (result.length > 0)
                {
                    ...
                    for (Object item : result)
                    {
                        ...
                        {
                            entireJProperties.addFormPackageName(packageToPath(((IPackageFragment) item).getElementName()));
                        }
                    }
        ...
        removeButton.addSelectionListener(new SelectionAdapter()
        {
            public void widgetSelected(SelectionEvent e)
            {
                 ...
                 */
                entireJProperties.getFormPackageNames().removeAll(Arrays.asList(items));
                editor.setDirty(true);
                refresh();
