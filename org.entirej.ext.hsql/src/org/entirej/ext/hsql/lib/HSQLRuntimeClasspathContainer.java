...
import org.entirej.ext.hsql.EJExtHSQLPlugin;
import org.entirej.ide.core.cf.CFProjectHelper;

public class HSQLRuntimeClasspathContainer implements IClasspathContainer
{
    public final static Path ID          = new Path("org.eclipse.hsql.runtime.EJ_HSQL_CONTAINER");

    final IPath              runtimePath = CFProjectHelper.getPathInPlugin(EJExtHSQLPlugin.getDefault().getBundle(), new Path("/extlibs/"));
    ...
    {
        return "EntireJ H2 Database Runtime Libraries.";
    }
