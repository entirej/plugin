...
import org.entirej.ide.cf.fx.lib.FXRuntimeVersions.Version;

public class FXCFRuntimeContainerPage extends WizardPage implements IClasspathContainerPage, IClasspathContainerPageExtension
{

    IJavaProject            javaProject;
    private IClasspathEntry containerEntryResult;

    public FXCFRuntimeContainerPage()
    {
        super("EntireJ JavaFX Runtime");
        containerEntryResult = JavaCore.newContainerEntry(FXCFRuntimeClasspathContainer.ID);
    }
    ...
    public void setSelection(IClasspathEntry containerEntry)
    {
        ...
        {
            containerEntry = JavaCore.newContainerEntry(FXCFRuntimeClasspathContainer.ID);
        }
