...
public class FXCFRuntimeClasspathContainerInitializer extends ClasspathContainerInitializer
{
    ...
    {
        FXCFRuntimeClasspathContainer container = new FXCFRuntimeClasspathContainer(containerPath);
