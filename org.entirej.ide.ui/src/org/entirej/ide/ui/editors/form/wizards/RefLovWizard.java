...
public class RefLovWizard extends NewWizard
{

    private int                       selection = Window.CANCEL;
    private RefLovSelectionPage       selectionPage;
    private final RefLovWizardContext wizardContext;

    public RefLovWizard(RefLovWizardContext wizardContext)
    {
        // setDialogSettings(EJUIPlugin.getDefault().getDialogSettings());
        setWindowTitle("Add Referenced LOV");
    ...
    {
        addPage(selectionPage = new RefLovSelectionPage(wizardContext));
        super.addPages();
    }
    ...
    protected void finishPage(IProgressMonitor monitor) throws InterruptedException, CoreException
    {
        ...
        wizardContext.addLov(selectionPage.getLovName(), selectionPage.getLovRef());
