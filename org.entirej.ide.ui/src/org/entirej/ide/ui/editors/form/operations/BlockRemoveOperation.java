...
public class BlockRemoveOperation extends AbstractOperation
{
    ...
    public BlockRemoveOperation(final AbstractNodeTreeSection treeSection, EJPluginBlockContainer container, EJPluginBlockProperties blockProperties,boolean cleanup)
    {
        super("Remove Block");
