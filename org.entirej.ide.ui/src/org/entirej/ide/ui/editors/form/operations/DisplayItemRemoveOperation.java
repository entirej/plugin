...
public class DisplayItemRemoveOperation extends AbstractOperation
{
    ...
    public DisplayItemRemoveOperation(final AbstractNodeTreeSection treeSection, EJPluginItemGroupProperties container,
            EJPluginScreenItemProperties blockProperties)
    {
        super("Remove Item ");
    ...
    public IStatus redo(IProgressMonitor monitor, IAdaptable info) throws ExecutionException
    {
        ...
        if (container != null)
        {
            ...
            index = container.deleteItem(blockProperties);
