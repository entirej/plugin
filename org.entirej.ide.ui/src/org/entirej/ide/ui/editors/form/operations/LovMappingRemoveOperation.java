...
public class LovMappingRemoveOperation extends AbstractOperation
{
    ...
    public LovMappingRemoveOperation(final AbstractNodeTreeSection treeSection, EJPluginLovMappingContainer container, EJPluginLovMappingProperties blockProperties)
    {
