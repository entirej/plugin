/*Copyright (c) 2003-2006 XClinical GmbH. 
...
public class ReversibleOperation extends AbstractOperation implements ICompositeOperation
{
    ...
    public IStatus undo(IProgressMonitor monitor, IAdaptable info) throws ExecutionException
    {
        ...
        List<IUndoableOperation> reverseOperations = new ArrayList<IUndoableOperation>(operations);
        Collections.reverse(reverseOperations);

        return iterate(MODE_UNDO, reverseOperations.iterator(), monitor, info);
    }

    protected IStatus iterate(final int mode, final Iterator<IUndoableOperation> iter, final IProgressMonitor monitor, final IAdaptable info)
    ...
    protected IStatus doIterate(int mode, Iterator<IUndoableOperation> iter, IProgressMonitor monitor, IAdaptable info) throws ExecutionException
    {
