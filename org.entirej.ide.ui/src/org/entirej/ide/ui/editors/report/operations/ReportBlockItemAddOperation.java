...
public class ReportBlockItemAddOperation extends AbstractOperation
{
    ...
    public ReportBlockItemAddOperation(final AbstractNodeTreeSection treeSection, EJReportBlockItemContainer container,
            EJPluginReportItemProperties blockProperties, int index)
    {
    ...
    public ReportBlockItemAddOperation(final AbstractNodeTreeSection treeSection, EJReportBlockItemContainer container,
            EJPluginReportItemProperties blockProperties)
    {
