...
public class NewEntireJFormWizard extends NewWizard implements IExecutableExtension
{
    ...
    public NewEntireJFormWizard()
    {
        ...
        setWindowTitle(EJUIMessages.NewFormWizard_title);
    ...
    public void addPages()
    {
        ...
        formCreationPage.setTitle(EJUIMessages.NewFormWizard_MainPage_title);
        formCreationPage.setDescription(EJUIMessages.NewFormWizard_MainPage_desc);
