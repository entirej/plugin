...
import org.entirej.ext.mysql.EJExtMySQLPlugin;
import org.entirej.ide.core.cf.CFProjectHelper;

public class MySQLRuntimeClasspathContainer implements IClasspathContainer
{
    public final static Path ID          = new Path("org.eclipse.mysql.runtime.EJ_MYSQL_CONTAINER");

    final IPath              runtimePath = CFProjectHelper.getPathInPlugin(EJExtMySQLPlugin.getDefault().getBundle(), new Path("/extlibs/"));
    ...
    {
        return "EntireJ MySQL Runtime Libraries.";
    }
