...
public class MySQLRuntimeClasspathContainerInitializer extends ClasspathContainerInitializer
{
    ...
    {
        MySQLRuntimeClasspathContainer container = new MySQLRuntimeClasspathContainer();
