...
import org.entirej.ext.jasper.EJExtJasperPlugin;
import org.entirej.ide.core.cf.CFProjectHelper;

public class ReportRuntimeClasspathContainer implements IClasspathContainer
{
    public final static Path ID          = new Path("org.eclipse.jasper.runtime.EJ_REPORT_JASPER_CONTAINER");

    final IPath              runtimePath = CFProjectHelper.getPathInPlugin(EJExtJasperPlugin.getDefault().getBundle(), new Path("/extlibs/"));
    ...
    {
        return "EntireJ Report Jasper 5.6.1 Runtime Libraries.";
    }
