...
import org.entirej.ext.oracle.EJExtOraclePlugin;
import org.entirej.ide.core.cf.CFProjectHelper;

public class OracleRuntimeClasspathContainer implements IClasspathContainer
{
    public final static Path ID          = new Path("org.eclipse.oracle.runtime.EJ_ORACLE_CONTAINER");

    final IPath              runtimePath = CFProjectHelper.getPathInPlugin(EJExtOraclePlugin.getDefault().getBundle(), new Path("/extlibs/"));
    ...
    {
        return "EntireJ Oracle Runtime Libraries.";
    }
