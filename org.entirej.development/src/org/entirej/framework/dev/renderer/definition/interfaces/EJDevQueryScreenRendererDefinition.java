...
public interface EJDevQueryScreenRendererDefinition extends EJQueryScreenRendererDefinition
{
    /**
     * Used to add an Query Screen Widget to the given <code>Control</code>
     * <p>
     ...
     * @return The Screen renderer definition control for this query screen
     *
     ...
     *             {@link EJDevQueryScreenPreviewProvider} to describe this
     *             screen in the GEF preview; renderers that do not are given a
     *             descriptor inferred from their renderer name.
     */
    @Deprecated
    default EJDevScreenRendererDefinitionControl addQueryScreenControl(EJDevBlockDisplayProperties blockDisplayProperties, Composite parent,
