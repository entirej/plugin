...
import org.entirej.framework.plugin.framework.properties.reader.FrameworkExtensionPropertiesListHandler;
...
import org.entirej.framework.reports.renderers.definitions.interfaces.EJReportFrameworkExtensionProperties.EJReportFrameworkExtensionPropertiesImpl;
...
public class FrameworkExtensionPropertiesHandler extends EntireJTagHandler
{
    ...
    private EJReportFrameworkExtensionPropertiesImpl _mainPropertyGroup;
    private EJReportFrameworkExtensionPropertiesImpl _currentPropertyGroup;
    ...
    public FrameworkExtensionPropertiesHandler(EJReportProperties formProperties, EJReportBlockProperties blockProperties, String exitTag)
    {
        _formProperties = formProperties;
        _blockProperties = blockProperties;
        _mainPropertyGroup = new EJReportFrameworkExtensionPropertiesImpl(formProperties, _blockProperties, "MAIN", null);
        _currentPropertyGroup = _mainPropertyGroup;
        _exitTag = exitTag;
    }
    
    public EJReportFrameworkExtensionProperties getMainPropertiesGroup()
    {
        return _mainPropertyGroup;
    }
    
    public EJReportFrameworkExtensionProperties getMainPropertiesGroup(EJPropertyDefinitionGroup base)
    {
    ...
    protected void validateProperties(EJPropertyDefinitionGroup group, EJReportFrameworkExtensionPropertiesImpl groupProp)
    {
        if (group != null && groupProp != null)
        {
            ...
            {
                EJReportFrameworkExtensionPropertiesImpl propertyGroup = groupProp.getPropertyGroup(subGroup.getName());
                if (propertyGroup == null)
                {
                    propertyGroup = new EJReportFrameworkExtensionPropertiesImpl(_formProperties, _blockProperties, subGroup.getName(), groupProp);
    ...
    public void startLocalElement(String name, Attributes attributes) throws SAXException
    {
        if (name.equals(ELEMENT_GROUP))
        {
            ...
            EJReportFrameworkExtensionPropertiesImpl props = new EJReportFrameworkExtensionPropertiesImpl(_formProperties, _blockProperties,
                    attributes.getValue("name"), _currentPropertyGroup);
    ...
    public void endLocalElement(String name, String value, String untrimmedValue)
    {
        ...
        if (name.equals(ELEMENT_GROUP))
        {
            ...
            // group to its parent
            _currentPropertyGroup = (EJReportFrameworkExtensionPropertiesImpl) _currentPropertyGroup.getParentGroup();
        }
        else if (name.equals(ELEMENT_PROPERTY))
        {
