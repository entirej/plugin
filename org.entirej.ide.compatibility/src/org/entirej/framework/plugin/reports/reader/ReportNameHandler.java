...
public class ReportNameHandler extends EntireJTagHandler
{
    ...
    public void endLocalElement(String name, String value, String untrimmedValue)
    {
        ...
        if (name.equals(ELEMENT_REPORT_DISPLAY_NAME))
        {
    ...
    {
        return reportDisplayName != null && reportDisplayName.length() > 0 ? reportDisplayName : reportName;
    }
