...
public class EJReportTableColumnAdapter extends WrappingTemplateModel implements AdapterTemplateModel, TemplateHashModel
{
    
    private final EJReportTableColumn column;
    
    private Map<String, String> values = new HashMap<String, String>();
    
    public EJReportTableColumnAdapter(EJReportTableColumn column, ObjectWrapper ow)
    {
