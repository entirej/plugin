...
public abstract class FieldEditorOverlayPage extends FieldEditorPreferencePage implements IWorkbenchPropertyPage
{
    ...
    protected final boolean     supportWorkspaceSettings;
    ...
    public FieldEditorOverlayPage(int style, boolean supportWorkspaceSettings)
    {
        super(style);
        this.supportWorkspaceSettings = supportWorkspaceSettings;
    }
    ...
    public void createControl(Composite parent)
    {
        ...
        if (isPropertyPage()) updateFieldEditors();
    }
    ...
    {
        if (isPropertyPage()) createSelectionGroup(parent);
    ...
    private void updateFieldEditors()
    {
        ...
        boolean enabled = !supportWorkspaceSettings || useProjectSettingsButton.getSelection();
    ...
    public boolean performOk()
    {
        ...
        if (result && isPropertyPage())
        {
            ...
            try
            {
                String value = (!supportWorkspaceSettings || useProjectSettingsButton.getSelection()) ? TRUE : FALSE;
