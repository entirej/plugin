 ...
 */
public class EJPluginDrawerPageCanvasContainer extends EJPluginCanvasContainer implements EJCanvasPropertiesContainer
{
    /**
     * 
     */
    private static final long serialVersionUID = -3069921111442543165L;
    private EJPluginDrawerPageProperties _tabPageProperties;
    
    public EJPluginDrawerPageCanvasContainer(EJPluginFormProperties formProperties, EJPluginDrawerPageProperties tabPageProperties)
    {
        super(formProperties);
        _tabPageProperties = tabPageProperties;
    }
    
    public EJPluginDrawerPageProperties getTabPageProperties()
    {
    ...
    {
        return _tabPageProperties.getDrawerCanvasProperties();
    }
}
