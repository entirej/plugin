...
public class EJPluginMenuLeafBranchProperties extends EJPluginMenuLeafProperties implements EJPluginMenuLeafContainer
{
    
    private List<EJPluginMenuLeafProperties> _menuLeaves;
    
    public EJPluginMenuLeafBranchProperties(EJPluginMenuProperties menu, EJPluginMenuLeafContainer container)
    {
