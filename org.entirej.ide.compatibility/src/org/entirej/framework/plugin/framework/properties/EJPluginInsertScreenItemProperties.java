...
public class EJPluginInsertScreenItemProperties implements EJDevInsertScreenItemDisplayProperties, EJPluginScreenItemProperties
{
    /**
     * 
     */
    private static final long serialVersionUID = 5018721164631053863L;
    private EJPluginItemGroupProperties    _itemGroupProperties;
    private EJPluginBlockProperties        _blockProperties;
    private EJFrameworkExtensionProperties _insertScreenRendererItemProperties;
    ...
    public EJPluginInsertScreenItemProperties(EJPluginItemGroupProperties itemGroupProperties, boolean addDefaults, boolean isSpacerItem)
    {
        _itemGroupProperties = itemGroupProperties;
        _blockProperties = itemGroupProperties.getBlockProperties();
        refreshInsertScreenRendererRequiredProperties(addDefaults);
    ...
    public void refreshInsertScreenRendererRequiredProperties(boolean addDefaults)
    {
        if (_blockProperties.getInsertScreenRendererDefinition() == null)
        {
            _insertScreenRendererItemProperties = null;
        }
        else
        {
            _insertScreenRendererItemProperties = ExtensionsPropertiesFactory.createInsertScreenRendererItemProperties(_blockProperties, addDefaults,
                    _insertScreenRendererItemProperties);
        }
    }
    ...
    {
        return _insertScreenRendererItemProperties;
    }
     ...
     */
    public void setInsertScreenRendererRequiredProperties(EJFrameworkExtensionProperties properties)
    {
        _insertScreenRendererItemProperties = properties;
    }
    ...
    /**
     * If set to <code>true</code>, this item will be visible on the insert
     * screen of the block
     * 
     * @param visible
     */
