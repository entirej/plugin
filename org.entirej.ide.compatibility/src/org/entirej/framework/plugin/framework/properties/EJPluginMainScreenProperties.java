...
public class EJPluginMainScreenProperties implements EJMainScreenProperties
{
    /**
     * 
     */
    private static final long serialVersionUID = 66726070913428389L;

    private EJPluginBlockProperties _blockProperties;
    
    private boolean                 _displayFrame;
    private String                  _blockFrameTitle    = "";
    ...
    public EJPluginMainScreenProperties(EJPluginBlockProperties blockProperties)
    {
     ...
     */
    public EJPluginMainScreenProperties makeCopy(EJPluginBlockProperties blockProperties)
    {
        EJPluginMainScreenProperties mainScreenProperties = new EJPluginMainScreenProperties(blockProperties);
        mainScreenProperties.setDisplayFrame(_displayFrame);
        mainScreenProperties.setFrameTitle(_blockFrameTitle);
