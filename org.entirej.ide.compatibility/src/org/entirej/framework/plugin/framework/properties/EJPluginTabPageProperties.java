...
public class EJPluginTabPageProperties implements EJTabPageProperties, EJPluginFormPreviewProvider
{
    /**
     * 
     */
    ...
    private EJPluginTabPageCanvasContainer _containedCanvases;
    
    public EJPluginTabPageProperties(EJPluginCanvasProperties tabCanvas, String name)
    {
        _name = name;
        _canvasProperties = tabCanvas;
        _containedCanvases = new EJPluginTabPageCanvasContainer(tabCanvas.getFormProperties(), this);
    }
    ...
    public EJPluginCanvasProperties getTabCanvasProperties()
    {
     ...
     * @see EJPluginTabPageProperties#isEnabled()
     */
     ...
     * @see EJPluginTabPageProperties#isVisible()
     */
     ...
     * @param enabled
     *            The enabled flag
     * @see EJPluginTabPageProperties#setVisible(boolean)
     */
     ...
     * @see EJPluginTabPageProperties#getFirstNavigationalItem()
     */
    ...
    public EJPluginTabPageCanvasContainer getContainedCanvases()
    {
