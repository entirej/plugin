...
public class UpdateScreenItemGroupHandler extends ItemGroupHandler
{
    private UpdateScreenItemHandler _itemHandler;
    
    public UpdateScreenItemGroupHandler(EJPluginItemGroupContainer itemGroupContainer, String exitTag)
    {
    ...
    {
        _itemHandler = new UpdateScreenItemHandler(getItemGroupProperties());
    ...
    {
        return new UpdateScreenItemGroupHandler(itemGroup.getChildItemGroupContainer(), "itemGroupList");
    }
}
