...
public class MainScreenHandler extends EntireJTagHandler
{
    private EJPluginBlockProperties      _blockProperties;
    private EJPluginMainScreenProperties _screenProperties;
    ...
    public MainScreenHandler(EJPluginBlockProperties blockProperties)
    {
        _blockProperties = blockProperties;
        _screenProperties = new EJPluginMainScreenProperties(blockProperties);
