...
public class InsertScreenItemGroupHandler extends ItemGroupHandler
{
    private InsertScreenItemHandler _itemHandler;
    
    public InsertScreenItemGroupHandler(EJPluginItemGroupContainer itemGroupContainer, String exitTag)
    {
    ...
    {
        _itemHandler = new InsertScreenItemHandler(getItemGroupProperties());
    ...
    {
        return new InsertScreenItemGroupHandler(itemGroup.getChildItemGroupContainer(), "itemGroupList");
    }
}
