...
public abstract class EntireJTagHandler extends DefaultHandler
{
    // delegate handling
    private EntireJTagHandler _delegateHandler = null;
     ...
     * 
     * Implementation should assign atributes for tags it handles itself or
