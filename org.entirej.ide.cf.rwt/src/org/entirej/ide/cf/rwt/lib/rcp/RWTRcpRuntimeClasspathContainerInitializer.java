...
public class RWTRcpRuntimeClasspathContainerInitializer extends ClasspathContainerInitializer
{
    ...
    {
        RWTRcpRuntimeClasspathContainer container = new RWTRcpRuntimeClasspathContainer(containerPath);
