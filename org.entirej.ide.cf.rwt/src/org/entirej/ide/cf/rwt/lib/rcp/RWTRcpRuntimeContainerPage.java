 ...
 ******************************************************************************/
package org.entirej.ide.cf.rwt.lib.rcp;
...
public class RWTRcpRuntimeContainerPage extends WizardPage implements IClasspathContainerPage, IClasspathContainerPageExtension
{

    IJavaProject            javaProject;
    private IClasspathEntry containerEntryResult;

    public RWTRcpRuntimeContainerPage()
    {
        super("EntireJ RWT/RCP Extensions");
        containerEntryResult = JavaCore.newContainerEntry(RWTRcpRuntimeClasspathContainer.ID);
    }
    ...
    public void setSelection(IClasspathEntry containerEntry)
    {
        ...
        {
            containerEntry = JavaCore.newContainerEntry(RWTRcpRuntimeClasspathContainer.ID);
        }
    ...
    public void createControl(Composite parent)
    {
        ...
        versionsList.setContentProvider(new IStructuredContentProvider()
        {
            ...
            {
                return new Object[] { RWTRuntimeVersions.CF_RCP_V_2_0 };
            }
        });
        versionsList.setInput(new Object());

        versionsList.setSelection(new StructuredSelection(RWTRuntimeVersions.CF_RCP_V_2_0));
