...
public class RWTRcpRuntimeClasspathContainer implements IClasspathContainer
{
    public final static Path ID = new Path("org.eclipse.rwt.runtime.EJCF_RWT_RCP_CONTAINER");
    ...
    public RWTRcpRuntimeClasspathContainer(IPath path)
    {
        ...
        description = "EntireJ RWT/RCP [2.3.3] Extension Libraries.";
    }
