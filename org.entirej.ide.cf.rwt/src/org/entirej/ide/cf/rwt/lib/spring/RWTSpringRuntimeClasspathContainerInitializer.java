...
public class RWTSpringRuntimeClasspathContainerInitializer extends ClasspathContainerInitializer
{
    ...
    {
        RWTSpringRuntimeClasspathContainer container = new RWTSpringRuntimeClasspathContainer(containerPath);
