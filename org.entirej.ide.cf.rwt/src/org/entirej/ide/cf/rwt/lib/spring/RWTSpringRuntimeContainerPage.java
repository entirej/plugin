 ...
 ******************************************************************************/
package org.entirej.ide.cf.rwt.lib.spring;
...
public class RWTSpringRuntimeContainerPage extends WizardPage implements IClasspathContainerPage, IClasspathContainerPageExtension
{

    IJavaProject            javaProject;
    private IClasspathEntry containerEntryResult;

    public RWTSpringRuntimeContainerPage()
    {
        super("EntireJ RWT/Spring Security  Extensions");
        containerEntryResult = JavaCore.newContainerEntry(RWTSpringRuntimeClasspathContainer.ID);
    }
    ...
    public void setSelection(IClasspathEntry containerEntry)
    {
        ...
        {
            containerEntry = JavaCore.newContainerEntry(RWTSpringRuntimeClasspathContainer.ID);
        }
    ...
    {
        setTitle("EntireJ RWT/Spring Security Runtime");
        setDescription("Add entirej rwt/spring security extension libraries to project path.");
        ...
        link.setText("EntireJ RWT/Spring Security extension classpath container.");
        ...
        versionsList.setContentProvider(new IStructuredContentProvider()
        {
            ...
            {
                return new Object[] { RWTRuntimeVersions.CF_SPRING_V_4 };
            }
        });
        versionsList.setInput(new Object());

        versionsList.setSelection(new StructuredSelection(RWTRuntimeVersions.CF_SPRING_V_4));
