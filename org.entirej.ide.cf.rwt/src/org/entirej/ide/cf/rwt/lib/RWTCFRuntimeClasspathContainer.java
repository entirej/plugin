...
public class RWTCFRuntimeClasspathContainer implements IClasspathContainer
{
    public final static Path ID          = new Path("org.eclipse.rwt.runtime.EJCF_RWT_CONTAINER");
    ...
    public RWTCFRuntimeClasspathContainer(IPath path)
    {
        ...
        description = "EntireJ RWT/CF [2.3.1] Runtime Libraries.";
    }
