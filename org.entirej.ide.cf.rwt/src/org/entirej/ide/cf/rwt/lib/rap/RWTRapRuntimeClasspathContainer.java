...
public class RWTRapRuntimeClasspathContainer implements IClasspathContainer
{
    public final static Path ID = new Path("org.eclipse.rwt.runtime.EJCF_RWT_RAP_CONTAINER");
    ...
    public RWTRapRuntimeClasspathContainer(IPath path)
    {
        ...
        description = "EntireJ RWT/RAP [4.0.0] Extension Libraries.";
    }
