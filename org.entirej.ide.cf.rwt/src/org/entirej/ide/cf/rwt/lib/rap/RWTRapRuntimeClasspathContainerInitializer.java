...
public class RWTRapRuntimeClasspathContainerInitializer extends ClasspathContainerInitializer
{
    ...
    {
        RWTRapRuntimeClasspathContainer container = new RWTRapRuntimeClasspathContainer(containerPath);
