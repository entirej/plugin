...
public class RWTSpringRuntimeClasspathContainer implements IClasspathContainer
{
    public final static Path ID = new Path("org.eclipse.rwt.runtime.EJCF_RWT_SPRING_CONTAINER");

    public RWTSpringRuntimeClasspathContainer(IPath path)
    {
        runtimePath = CFProjectHelper.getPathInPlugin(EJCFRwtPlugin.getDefault().getBundle(), new Path("/extlibs-spring/"));
        description = "EntireJ RWT/Spring Security [4.0.3] Extension Libraries.";
    }
