...
public class RWTRapRuntimeContainerPage extends WizardPage implements IClasspathContainerPage, IClasspathContainerPageExtension
{

    IJavaProject            javaProject;
    private IClasspathEntry containerEntryResult;

    public RWTRapRuntimeContainerPage()
    {
        super("EntireJ RWT/RAP Extensions");
        containerEntryResult = JavaCore.newContainerEntry(RWTRapRuntimeClasspathContainer.ID);
    }
    ...
    public void setSelection(IClasspathEntry containerEntry)
    {
        ...
        {
            containerEntry = JavaCore.newContainerEntry(RWTRapRuntimeClasspathContainer.ID);
        }
    ...
    public void createControl(Composite parent)
    {
        ...
        versionsList.setContentProvider(new IStructuredContentProvider()
        {
            ...
            {
                return new Object[] { RWTRuntimeVersions.CF_RAP_V_2_1 };
            }
        });
        versionsList.setInput(new Object());

        versionsList.setSelection(new StructuredSelection(RWTRuntimeVersions.CF_RAP_V_2_1));
