...
public class RWTCoreRuntimeClasspathContainerInitializer extends ClasspathContainerInitializer
{
    ...
    {
        RWTCoreRuntimeClasspathContainer container = new RWTCoreRuntimeClasspathContainer();
