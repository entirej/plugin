...
public class RWTSpringClientFrameworkProvider implements ClientFrameworkProvider {
	...
	public void addEntireJNature(IConfigurationElement configElement, IJavaProject project, IProgressMonitor monitor) {
		try {
			...
			CFProjectHelper.addFile(project, EJCFRwtPlugin.getDefault().getBundle(), RWT_APP_ACCESSDENIEDSERVLET,
					"src/org/entirej/AccessDeniedServlet.java");
			CFProjectHelper.addFile(project, EJCFRwtPlugin.getDefault().getBundle(), RWT_APP_LOGINSERVLET,
					"src/org/entirej/LoginServlet.java");
			CFProjectHelper.addFile(project, EJCFRwtPlugin.getDefault().getBundle(), RWT_WEB_DD,
					"WebContent/WEB-INF/web.xml");
			CFProjectHelper.addFile(project, EJCFRwtPlugin.getDefault().getBundle(), RWT_WEB_BANNER,
					"WebContent/resources/banner.png");
			CFProjectHelper.addFile(project, EJCFRwtPlugin.getDefault().getBundle(), RWT_WEB_INDEX,
			...
			CFProjectHelper.addFile(project, EJCFRwtPlugin.getDefault().getBundle(), getComponentSource(project),
...
//			CFProjectHelper.addToClasspath(project, JavaCore.newContainerEntry(RWTCFRuntimeClasspathContainer.ID,
...
//					new IAccessRule[0], attributes, true));
//			CFProjectHelper.addToClasspath(project, JavaCore.newContainerEntry(RWTRapRuntimeClasspathContainer.ID,
//					new IAccessRule[0], attributes, true));
...
//					new IAccessRule[0], attributes, true));
			CFProjectHelper.addToClasspath(project,
					JavaCore.newContainerEntry(new Path("org.eclipse.jst.j2ee.internal.web.container")));
			CFProjectHelper.addToClasspath(project,
					JavaCore.newContainerEntry(new Path("org.eclipse.jst.j2ee.internal.module.container")));
