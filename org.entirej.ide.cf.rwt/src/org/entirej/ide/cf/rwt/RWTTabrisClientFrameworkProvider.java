...
import org.entirej.ide.cf.rwt.lib.tabris.RWTCFRuntimeClasspathContainer;
import org.entirej.ide.cf.rwt.lib.tabris.RWTCoreRuntimeClasspathContainer;
...
public class RWTTabrisClientFrameworkProvider implements ClientFrameworkProvider
{
    ...
    {
        return "Mobile Application Framework (Tabris)";
    }

    public String getProviderId()
    {
        return "org.entirej.framework.cf.rwt_tabris";
    }

    public String getDescription()
    {
        return "Creates a project adding the Mobile Application Framework (EclipseSource Tabris) and renderers.\nThe application.ejprop file will be pre-configured with references to the Tabris Renderers";
    }
