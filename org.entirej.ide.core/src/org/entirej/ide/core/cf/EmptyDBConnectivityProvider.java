...
public class EmptyDBConnectivityProvider implements DBConnectivityProvider
{
    ...
    {
        return "org.entirej.framework.dbn.empty";
    }

    public String getDescription()
    {
        return "Empty database connection settings";
    }
