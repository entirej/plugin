...
public class DevRuntimeClasspathContainerInitializer extends ClasspathContainerInitializer
{
    ...
    {
        DevRuntimeClasspathContainer container = new DevRuntimeClasspathContainer();
