...
public class CoreRuntimeClasspathContainerInitializer extends ClasspathContainerInitializer
{

    public final static IPath  ID       = new Path("org.eclipse.core.runtime.EJ_CORE_CONTAINER");
    ...
    {
        CoreRuntimeClasspathContainer container = new CoreRuntimeClasspathContainer(containerPath);
