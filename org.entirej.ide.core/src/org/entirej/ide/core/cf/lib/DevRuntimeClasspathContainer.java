...
public class DevRuntimeClasspathContainer implements IClasspathContainer
{
    public final static Path ID          = new Path("org.eclipse.core.runtime.EJ_DEV_CONTAINER");

    final IPath              runtimePath = CFProjectHelper.getPathInPlugin(EJRuntimePlugin.getDefault().getBundle(), new Path("/extlibs-dev/"));
    ...
    {
        return "EntireJ CF Development  Libraries.";
    }
