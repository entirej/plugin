...
import org.entirej.ide.core.report.lib.ReportRuntimeVersions.Version;

public class ReportRuntimeContainerPage extends WizardPage implements IClasspathContainerPage, IClasspathContainerPageExtension
{
    ...
    {
        super("EntireJ Report Runtime");
        containerEntryResult = JavaCore.newContainerEntry(ReportRuntimeClasspathContainerInitializer.ID);
    }
    ...
    public void setSelection(IClasspathEntry containerEntry)
    {
        ...
        {
            containerEntry = JavaCore.newContainerEntry(ReportRuntimeClasspathContainerInitializer.ID);
        }
    ...
    {
        setTitle("EntireJ Report Runtime");
        setDescription("Add entirej report libraries to project path.");
        ...
        link.setText("EntireJ report runtime classpath container.");
        ...
        versionsList.setLabelProvider(new ColumnLabelProvider()
        {
            ...
            {
                if (element instanceof ReportRuntimeVersions.Version)
                {
        ...
        versionsList.setContentProvider(new IStructuredContentProvider()
        {
            ...
            {
                return new Object[] { ReportRuntimeVersions.V_2_3 };
            }
        });
...
//        else
//        {
            versionsList.setSelection(new StructuredSelection(ReportRuntimeVersions.V_2_3));
 //       }
        ...
        versionsList.addSelectionChangedListener(new ISelectionChangedListener()
        {
            ...
            public void selectionChanged(SelectionChangedEvent event)
            {
                ...
                {
                    Version version = (Version) selection.getFirstElement();
